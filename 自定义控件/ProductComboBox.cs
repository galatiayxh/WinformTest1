...
{
    /// <summary>
    /// <c>ProductComboBox</c> is an extension of <c>ComboBox</c> which provides drop-down customization.
    /// </summary>
    [SecurityPermission(SecurityAction.LinkDemand, Flags = SecurityPermissionFlag.UnmanagedCode)]
    //[Designer(typeof(ProductComboBoxDesigner))]
    public partial class ProductComboBox : ComboBox, IPopupControlHost
    {
        ...
        public ProductComboBox(System.Windows.Forms.Control dropControl)
            : this()
        {
        ...
        {
            HideDropDown(HideCloseReason.AppFocusChange);
        }
        ...
        protected virtual void AssignControl(System.Windows.Forms.Control control)
        {
            ...
            if (control != null && control != DropDownControl)
            {
        ...
        /// Actual drop-down control itself.
        /// </summary>
        private System.Windows.Forms.Control m_dropDownCtrl;
        ...
        private void InitializeComponent()
        {
            ...
            // ProductComboBox
            // 
            //KeyDown += ProductComboBox_KeyDown;
            //Enter += ProductComboBox_Enter;
            ResumeLayout(false);
        }
        ...
        //    int selectionLenth = this.SelectionLength;
        //    if (e.KeyData != Keys.Return)
        //    {
        //        base.OnKeyDown(e);
        //        if (e.KeyData != Keys.F9 && e.KeyData != Keys.F11)
        //        {
        //            //this.ShowDropDown(selectionStart, selectionLenth);
        //            if (!IsDroppedDown)
        //                ShowDropDown();
        //        }
        //    }
    ...
    public class PopupDropDown : ToolStripDropDown
    {
        ...
        {
            System.Windows.Forms.Control hostedControl = GetHostedControl();
        ...
        public System.Windows.Forms.Control GetHostedControl()
        {
            if (Items.Count > 0)
            {
    ...
    public interface IPopupControlHost
    {
        ...
        /// Hides drop-down area of combo box, if shown.
        /// </summary>
        void HideDropDown(HideCloseReason reason);
    ...
    public class PopupControl
    {
        ...
        protected void InitializeHost(System.Windows.Forms.Control control)
        {
            InitializeDropDown();
